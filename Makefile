# This Makefile is for the Device::USB::Relay extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Device/USB/Relay.pm]
#     AUTHOR => q[Gerd <busker@>]
#     NAME => q[Device::USB::Relay]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Device/USB/Relay.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = Device::USB::Relay
NAME_SYM = Device_USB_Relay
VERSION = 0.01
...
MAKE = make
FULLEXT = Device/USB/Relay
BASEEXT = Relay
PARENT_NAME = Device::USB
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Device/USB/Relay.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Device/USB/Relay.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/Device/USB
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Device/USB
...
TO_INST_PM = lib/Device/USB/Relay.pm

PM_TO_BLIB = lib/Device/USB/Relay.pm \
	blib/lib/Device/USB/Relay.pm
...
DISTNAME = Device-USB-Relay
DISTVNAME = Device-USB-Relay-0.01
...
manifypods : pure_all  \
	lib/Device/USB/Relay.pm
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Device/USB/Relay.pm $(INST_MAN3DIR)/Device::USB::Relay.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Gerd &lt;busker@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Device/USB/Relay.pm blib/lib/Device/USB/Relay.pm 
